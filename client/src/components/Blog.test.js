...
describe('Blog functionality', () => {
	...
	test('rendered blog shows title and author', () => {
		...
		expect(component.container).not.toHaveTextContent('5000 likes')
	...
	test('blog renders also url and likes when show button is clicked', () => {
		...
		expect(component.container).toHaveTextContent('didzis.net')

		expect(component.container).toHaveTextContent('122 likes')
		// component.debug()
	})
